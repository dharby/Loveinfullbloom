...
function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-4 right-4 z-50 w-10 h-10 rounded-full bg-mint/80 backdrop-blur-sm flex items-center justify-center text-cream/80 hover:text-cream hover:bg-mint transition-all duration-300 md:top-6 md:right-6"
