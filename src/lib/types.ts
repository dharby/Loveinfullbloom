...
export const RSVP_CATEGORIES: { value: RSVPCategory; label: string; detail: string }[] = [
  { value: "brides_parents", label: "Bride's Family", detail: "Pharm (Apostle) Adewole Philus-Ogun & Pastor Mrs Omolara Akin-Ojo" },
  { value: "grooms_parents", label: "Groom's Family", detail: "Mr Samson & Mrs Olajoke Ekwubiri" },
  { value: "couple", label: "The Couple", detail: "Oreoluwa & Daberechukwu" },
];
