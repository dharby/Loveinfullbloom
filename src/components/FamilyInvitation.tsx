    ...
    <section className="py-14 md:py-20 bg-cream">
      <div className="max-w-2xl mx-auto px-5 text-center">
        <motion.p
          ...
          viewport={{ once: true }}
          variants={reveal}
          className="text-[0.7rem] sm:text-[0.75rem] uppercase tracking-[0.3em] text-lavender/70 font-sans mb-4"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          variants={reveal}
          className="text-[1.1rem] sm:text-[1.25rem] font-serif text-mint font-medium leading-relaxed mb-2"
        >
        ...
        <motion.span
          ...
          viewport={{ once: true }}
          variants={reveal}
          className="block text-lavender text-[1.1rem] font-serif my-3"
        >
          &amp;
        </motion.span>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          variants={reveal}
          className="text-[1.1rem] sm:text-[1.25rem] font-serif text-mint font-medium leading-relaxed mb-4"
        >
