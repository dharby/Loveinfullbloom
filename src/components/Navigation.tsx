  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-[0.9rem] font-script text-mint dark:text-lavender">{weddingData.monogram.first}&amp;{weddingData.monogram.second}</span>
        <div className="w-7" />
      </motion.div>
        ...
        {open && (
          <>
            <motion.div
              ...
              className="fixed inset-0 z-[60] bg-mint/20 backdrop-blur-sm md:hidden"
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 bottom-0 w-72 z-[70] bg-cream dark:bg-mint border-r border-sage/50 dark:border-lavender/30 md:hidden"
            >
              ...
              <nav className="flex flex-col px-5 pt-6 gap-1">
                {links.map((l, i) => (
                  <motion.button
                    ...
                    onClick={() => nav(l.href)}
                    className="text-left py-3 text-[0.65rem] sm:text-[0.7rem] uppercase tracking-[0.18em] font-sans text-ink-soft dark:text-cream hover:text-lavender border-b border-sage/20 dark:border-lavender/20 transition-colors"
                  >
                    {l.name}
                  </motion.button>
                ))}
