      ...
      <div className="max-w-5xl mx-auto px-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 auto-rows-[8rem] sm:auto-rows-[10rem]">
          {photos.map((photo, i) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-sage-light via-cream to-sage/20 opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-mint/0 group-hover:bg-mint/[0.04] transition-colors duration-500" />
            </motion.div>
          ))}
        </div>
